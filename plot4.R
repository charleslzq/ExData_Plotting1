...
plot(data2007$Voltage, type="l", ylab="Voltage", xlab="Datetime");
plot(data2007$Sub_metering_1,col="grey", type="l", ylim=c(0,40), ylab="Energy sub metering", xlab="Datetime");
...
plot(data2007$Global_reactive_power, type="l", ylab="Global Reactive Power(kilowatts)", xlab="Datetime");
dev.off();